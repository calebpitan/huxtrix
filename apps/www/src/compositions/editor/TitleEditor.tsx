...
export function TitleEditor({
  ...
  return (
    ...
    >
      <textarea
        className="placeholder:text-muted-foreground field-sizing-content flex h-[calc(100%_+_0.111em)] resize-none overflow-visible focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
        spellCheck="false"
        rows={1}
